...
def get_season(auth_token=None, session=None):
    return generic.process_response(
        generic.geotastic_api_request(
            session,
            "https://backend03.geotastic.net/v1/season/getSeason.php",
            "GET",
            auth_token,
        )
    )
...
@Client._register_endpoint
def get_current_user_statistics(uid, auth_token=None, session=None):
    return generic.process_response(
        generic.geotastic_api_request(
            session,
...
@Client._register_endpoint
def get_season_progress_leaderboard(id, auth_token=None, session=None):
    return generic.process_response(
        generic.geotastic_api_request(
            session,
...
@Client._register_endpoint
def get_all_matchmaking(auth_token=None, session=None):
    return generic.process_response(
        generic.geotastic_api_request(
            session,
