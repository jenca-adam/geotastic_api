...
def get_all_user_challenges(auth_token=None, session=None):
...
@Client._register_endpoint
def get_challenge_drops(challenge_id, auth_token=None, session=None):
    return generic.process_response(
        generic.geotastic_api_request(
            session,
...
@Client._register_endpoint
def get_challenge(uid, auth_token=None, session=None):
    return generic.process_response(
        generic.geotastic_api_request(
            session,
...
@Client._register_endpoint
def get_challenge_results(challenge_id, auth_token=None, session=None):
    return generic.process_response(
        generic.geotastic_api_request(
            session,
...
@Client._register_endpoint
def get_own_challenges(auth_token=None, session=None):
    return generic.process_response(
        generic.geotastic_api_request(
            session,
...
@Client._register_endpoint
def create_draft_challenge(
    challenge_name, challenge_type="custom", auth_token=None, session=None
):
...
@Client._register_endpoint
def update_last_round_seen(challenge_id, round_no, auth_token=None, session=None):
...
@Client._register_endpoint
def finish_challenge(challenge_id, auth_token=None, session=None):
...
def publish_challenge(
    challenge_id, status="published", scheduled_date="", auth_token=None, session=None
):
    data = generic.encode_encdata(
...
def update_challenge(
    challenge_id, name, description, visibility, image="", auth_token=None, session=None
):
    data = generic.encode_encdata(
        {
            "id": challenge_id,
...
@Client._register_endpoint
def start_challenge(challenge_uid, auth_token=None, session=None):
    data = generic.encode_encdata(
        {
            "uid": challenge_uid,
        }
